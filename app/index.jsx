...
const Index = () => {
    ...
    return (
        <SafeAreaView className={`flex-1 p-5 justify-evenly items-center`} style={{backgroundColor:colors.background_c1}} >
            <Text className={`text-4xl font-bold text-center`} style={{color:colors.primary}}>Welcome to Howah!</Text>
            <Text className={`font-bold text-center`} style={{color:colors.text}}>Learn more about your favorite movies, in the comfort of your home</Text>
